...
import { useGetPatientQuery, useUpdatePatientMutation } from "@/store/services/patients"
...
export function EditPatientSheet({ patient, open, onOpenChange }: EditPatientSheetProps) {
  ...
  useEffect(() => {
    if (isError) {
      toast.error("Something wrong happened while updating the patient!")
    }
  }, [isError])
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader className="px-8 pt-8 pb-6 border-b border-gray-200">
          <SheetTitle className="text-2xl font-semibold text-gray-900">Edit Patient</SheetTitle>
          <SheetDescription className="text-sm text-gray-600">Update the patient information below</SheetDescription>
        </SheetHeader>
