...
function DashboardHeaderContent({ onSearch }: DashboardHeaderProps) {
  ...
  return (
    <div className="z-50">
      {/* Desktop Header */}
      <nav className="hidden md:flex items-center z-[9999] border-b border-blue-200 h-16 ml-64 bg-gradient-to-r from-pink-100 via-blue-50 to-cyan-100 backdrop-blur-md">
...
export default function DashboardHeader(props: DashboardHeaderProps) {
  return (
    <Suspense fallback={
      <nav className="hidden md:flex items-center fixed top-0 right-0 left-0 z-[9999] border-b border-blue-200 h-16 ml-64 bg-gradient-to-r from-pink-100 via-blue-50 to-cyan-100 backdrop-blur-md">
        <div className="flex-1 flex items-center justify-between px-6">
